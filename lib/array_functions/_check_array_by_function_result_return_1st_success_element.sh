...
#
# @example
#	printf "%s\n" "${array[@]}" | check_array_by_function_result_return_1st_success_element "bfl::is_alpha"
# bfl::check_array_by_function_result_return_1st_success_element "bfl::is_alpha" < <(printf "%s\n" "${array[@]}")
#------------------------------------------------------------------------------
