...
#  bfl::function_exists "bfl::isTerminal" || { bfl::writelog_fail "${FUNCNAME[0]}: function isTerminal not found"; return $BFL_ErrCode_Not_verified_arg_values; }   # Verify dependencies.
